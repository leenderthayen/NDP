...
//
//
// G4MicroElecElastic_new.cc, 2011/08/29 A.Valentin, M. Raine
//
...
G4MicroElecElastic_new::G4MicroElecElastic_new(const G4String& processName,
...
G4MicroElecElastic_new::~G4MicroElecElastic_new()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

G4bool G4MicroElecElastic_new::IsApplicable(const G4ParticleDefinition& p)
{
...
void G4MicroElecElastic_new::InitialiseProcess(const G4ParticleDefinition*)
{
  if(!isInitialised)
  {
    isInitialised = true;
...
void G4MicroElecElastic_new::PrintInfo()
{
