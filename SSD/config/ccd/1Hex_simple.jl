...
function SolidStateDetectors.get_charge_density(cdm::CustomChargeDensity{T}, pt::SolidStateDetectors.AbstractCoordinatePoint{T})::T where {T}
	cd::T = 0
	cd += (pt in cdm.G1) * SolidStateDetectors.get_charge_density(cdm.L1, pt)
	cd += (pt in cdm.G2) * SolidStateDetectors.get_charge_density(cdm.L2, pt)
	cd += (pt in cdm.G3) * SolidStateDetectors.get_charge_density(cdm.L3, pt)
	return cd
end
...
CD1 = SolidStateDetectors.LinearChargeDensity{T}((0.0f0,0.0f0,4e+16),(0.0f0,0.0f0,0.0f0))
CD2 = SolidStateDetectors.LinearChargeDensity{T}((0.0f0,0.0f0,-1e+25),(0.0f0,0.0f0,0.0f0))
G3 = SolidStateDetectors.HexagonalPrism{T}(0, 0.00515, 2e-05,CartesianPoint{T}(0, 0, 0.00199),0)
CD3= SolidStateDetectors.LinearChargeDensity{T}((0.0f0,0.0f0,1e+22),(0.0f0,0.0f0,0.0f0))
